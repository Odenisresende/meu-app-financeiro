-- =====================================================
-- 📝 TABELA DE LOGS DE WEBHOOKS (CORRIGIDA)
-- =====================================================
...
-- 3. Índice para busca no JSON (CORRIGIDO)
CREATE INDEX IF NOT EXISTS idx_webhook_logs_payload_gin ON public.webhook_logs USING GIN (payload);
